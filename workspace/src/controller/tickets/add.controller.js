module.exports = {
    ...
    createNewTickets: async (uuid, iduser, worktype, description, images) => {
        const insert = await require('../../lib/database/tickets.database').insert(uuid, iduser, worktype, description, images);
